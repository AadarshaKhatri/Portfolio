...
const Feeds = () => {
  ...
  return (
    <section>
      <div className="flex flex-row items-center gap-2 absolute left-[100px] top-[790px]  md:left-[220px] md:top-[740px] lg:left-[520px] lg:top-[750px]">
